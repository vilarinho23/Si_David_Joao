...
/**
 * A classe library.LibrarySI representa uma biblioteca de segurança para gestão de licenças.
...
public class LibrarySI {
    ...
    /**
     * Construtor da class library.LibrarySI.
    ...
    private static class CardReader {
        ...
        public static Provider getProv() {
            String configpath = "src/resources/pkcs11cc.cfg";
